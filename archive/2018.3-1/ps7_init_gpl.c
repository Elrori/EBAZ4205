...
unsigned long ps7_ddr_init_data_3_0[] = {
    ...
    EMIT_MASKWRITE(0XF800612C, 0x000FFFFFU ,0x0001F000U),
    EMIT_MASKWRITE(0XF8006130, 0x000FFFFFU ,0x0001F000U),
    EMIT_MASKWRITE(0XF8006134, 0x000FFFFFU ,0x0001F000U),
    EMIT_MASKWRITE(0XF8006138, 0x000FFFFFU ,0x0001F000U),
    ...
    EMIT_MASKWRITE(0XF8006168, 0x001FFFFFU ,0x000000D1U),
    EMIT_MASKWRITE(0XF800616C, 0x001FFFFFU ,0x000000D1U),
    EMIT_MASKWRITE(0XF8006170, 0x001FFFFFU ,0x000000D1U),
    EMIT_MASKWRITE(0XF8006174, 0x001FFFFFU ,0x000000D1U),
